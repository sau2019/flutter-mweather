...
import 'package:mweather/homepage/forecast_page.dart';
...
class MainContent extends StatefulWidget {
  ...
  MainContent({Key key, @required this.latitude, @required this.longitude})
      : super(key: key);
    ...
    return FutureBuilder<Album>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return Center(child: Text(" It seems that you have no Internet."));
        }
